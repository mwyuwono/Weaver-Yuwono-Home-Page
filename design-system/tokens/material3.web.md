# Material Design 3 Web Tokens

## Metadata

- **Generated**: 2025-11-24T21:18:54.890Z
- **Token Count**: 80
...
| ID | Value | Description | Custom | Theme |
|----|-------|-------------|--------|------|
| `md.ref.palette.black` | `#000000ff` | Black |  | - |
| `md.ref.palette.error0` | `#000000ff` | Error 0 |  | - |
| `md.ref.palette.error10` | `#410e0bff` | Error 10 |  | - |
| `md.ref.palette.error100` | `#ffffffff` | Error 100 |  | - |
| `md.ref.palette.error20` | `#601410ff` | Error 20 |  | - |
| `md.ref.palette.error30` | `#8c1d18ff` | Error 30 |  | - |
| `md.ref.palette.error40` | `#b3261eff` | Error 40 |  | - |
| `md.ref.palette.error50` | `#dc362eff` | Error 50 |  | - |
| `md.ref.palette.error60` | `#e46962ff` | Error 60 |  | - |
| `md.ref.palette.error70` | `#ec928eff` | Error 70 |  | - |
| `md.ref.palette.error80` | `#f2b8b5ff` | Error 80 |  | - |
| `md.ref.palette.error90` | `#f9dedcff` | Error 90 |  | - |
...
| `md.ref.palette.neutral-variant30` | `#49454fff` | Neutral Variant 30 |  | - |
| `md.ref.palette.neutral-variant40` | `#605d66ff` | Neutral Variant 40 |  | - |
| `md.ref.palette.neutral-variant50` | `#79747eff` | Neutral Variant 50 |  | - |
| `md.ref.palette.neutral-variant60` | `#938f99ff` | Neutral Variant 60 |  | - |
| `md.ref.palette.neutral-variant70` | `#aea9b4ff` | Neutral Variant 70 |  | - |
| `md.ref.palette.neutral-variant80` | `#cac4d0ff` | Neutral Variant 80 |  | - |
| `md.ref.palette.neutral-variant90` | `#e7e0ecff` | Neutral Variant 90 |  | - |
| `md.ref.palette.neutral-variant95` | `#f5eefaff` | Neutral Variant 95 |  | - |
| `md.ref.palette.neutral-variant99` | `#fffbfeff` | Neutral Variant 99 |  | - |
| `md.ref.palette.neutral0` | `#000000ff` | Neutral 0 |  | - |
| `md.ref.palette.neutral10` | `#1c1b1fff` | Neutral 10 |  | - |
| `md.ref.palette.neutral100` | `#ffffffff` | Neutral 100 |  | - |
| `md.ref.palette.neutral20` | `#313033ff` | Neutral 20 |  | - |
...
| `md.ref.palette.neutral60` | `#939094ff` | Neutral 60 |  | - |
| `md.ref.palette.neutral70` | `#aeaaaeff` | Neutral 70 |  | - |
| `md.ref.palette.neutral80` | `#c9c5caff` | Neutral 80 |  | - |
| `md.ref.palette.neutral90` | `#e6e1e5ff` | Neutral 90 |  | - |
| `md.ref.palette.neutral95` | `#f4eff4ff` | Neutral 95 |  | - |
| `md.ref.palette.neutral99` | `#fffbfeff` | Neutral 99 |  | - |
| `md.ref.palette.primary0` | `#000000ff` | Primary 0 |  | - |
| `md.ref.palette.primary10` | `#21005dff` | Primary 10 |  | - |
| `md.ref.palette.primary100` | `#ffffffff` | Primary 100 |  | - |
| `md.ref.palette.primary20` | `#381e72ff` | Primary 20 |  | - |
| `md.ref.palette.primary30` | `#4f378bff` | Primary 30 |  | - |
| `md.ref.palette.primary40` | `#6750a4ff` | Primary 40 |  | - |
...
| `md.ref.palette.primary80` | `#d0bcffff` | Primary 80 |  | - |
| `md.ref.palette.primary90` | `#eaddffff` | Primary 90 |  | - |
...
| `md.ref.palette.secondary30` | `#4a4458ff` | Secondary 30 |  | - |
| `md.ref.palette.secondary40` | `#625b71ff` | Secondary 40 |  | - |
...
| `md.ref.palette.secondary80` | `#ccc2dcff` | Secondary 80 |  | - |
| `md.ref.palette.secondary90` | `#e8def8ff` | Secondary 90 |  | - |
...
| `md.ref.palette.tertiary30` | `#633b48ff` | Tertiary 30 |  | - |
| `md.ref.palette.tertiary40` | `#7d5260ff` | Tertiary 40 |  | - |
...
| `md.ref.palette.tertiary80` | `#efb8c8ff` | Tertiary 80 |  | - |
| `md.ref.palette.tertiary90` | `#ffd8e4ff` | Tertiary 90 |  | - |
| `md.ref.palette.tertiary95` | `#ffecf1ff` | Tertiary 95 |  | - |
| `md.ref.palette.tertiary99` | `#fffbfaff` | Tertiary 99 |  | - |
| `md.ref.palette.white` | `#ffffffff` | White |  | - |
